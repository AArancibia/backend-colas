...
export class VentanillaController {
  ...
  obtenerVentanillaporIdPersonal(@Param('idusuario') idusuario: number) {
  ...
  ventanillaUltimoEstadoPorId(@Param('id') id: number) {
  ...
  @Post()
  guardarVentanilla(@Body() ventanilla: VentanillaDTO) {
